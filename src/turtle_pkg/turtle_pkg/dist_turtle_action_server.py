...
from turtle_pkg.my_subscriber import TurtlesimSubscriber
...
class DistTurtleServer(Node):
    def __init__(self):
        ...
        self.declare_parameter('quatile_time', 0.75,param_desc_quantile) #
        self.declare_parameter('almost_goal_time', 0.95)
				#파라미터를 받아와서 프린트 해주는 부분
        (quantile_time, almosts_time) = self.get_parameters(
                                            ['quatile_time', 'almost_goal_time'])
        print('quantile_time and almosts_time is ',quantile_time.value,almosts_time.value)
    ...
    def parameter_callback(self,params):
        ...
        output_msg = output_msg + "and almost_goal_time is " + str(self.quantile_time) + ". "
